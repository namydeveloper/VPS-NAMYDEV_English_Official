...
cd socks
patch="https://raw.githubusercontent.com/namydeveloper/VPS-NAMYDEV_English_Official/master/LINKS-LIBRARIES/backsocz.zip"
arq="backsocz.zip"
...
screen -dmS getpy python ${SCPinst}/PGet.py -b "0.0.0.0:$1" -p "${SCPinst}/pwd.pwd"
 ...
 echo -e "\033[1;32m namydeveloper"
 msg -bar
...
msg -bar 
msg -tit
msg -ama "   INSTALLER OF PROXY'S VPS-AGN By MOD @namydeveloper"
msg -bar
