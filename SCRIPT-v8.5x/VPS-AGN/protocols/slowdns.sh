#!/bin/bash
 ...
 ini_slow(){
     ...
     if [[ ! -e ${ADM_inst}/dns-server ]]; then
     	...
     	if wget -O ${ADM_inst}/dns-server https://raw.githubusercontent.com/namydeveloper/VPS-NAMYDEV_English_Official/master/LINKS-LIBRARIES/dns-server &>/dev/null ; then
