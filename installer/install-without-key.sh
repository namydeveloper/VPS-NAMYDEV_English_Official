...
v1=$(curl -sSL "https://raw.githubusercontent.com/namydeveloper/VPS-NAMYDEV_English_Official/master/SCRIPT-v8.5x/Version")
...
repo() {
  link="https://raw.githubusercontent.com/namydeveloper/Multi-Script/main/Source-List/20.04.list"
  case $1 in
...
post_reboot() {
  echo 'wget -O /root/install.sh "https://raw.githubusercontent.com/namydeveloper/VPS-NAMYDEV_English_Official/master/installer/install-without-key.sh"; clear; sleep 2; chmod +x /root/install.sh; /root/install.sh --continue' >>/root/.bashrc
...
msg -bar
#-BASH SOPORTE ONLINE
wget https://raw.githubusercontent.com/namydeveloper/VPS-NAMYDEV_English_Official/master/LINKS-LIBRARIES/SPR.sh -O /usr/bin/SPR >/dev/null 2>&1
chmod +x /usr/bin/SPR
...
install_official() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/namydeveloper/VPS-NAMYDEV_English_Official/master/SCRIPT-v8.5x/VPS-AGN.tar.xz >/dev/null 2>&1
  ...
  wget https://raw.githubusercontent.com/namydeveloper/VPS-NAMYDEV_English_Official/master/LINKS-LIBRARIES/monitor.sh -P /bin/
  ...
  wget -O /bin/resetsshdrop https://raw.githubusercontent.com/namydeveloper/VPS-NAMYDEV_English_Official/master/LINKS-LIBRARIES/resetsshdrop &>/dev/null
  ...
  v1=$(curl -sSL "https://raw.githubusercontent.com/namydeveloper/VPS-NAMYDEV_English_Official/master/SCRIPT-v8.5x/Version")
  echo "$v1" >/etc/versin_script
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/namydeveloper/VPS-NAMYDEV_English_Official/master/SCRIPT-v8.5x/Version &>/dev/null
  ...
  echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/namydeveloper/VPS-NAMYDEV_English_Official/master/SCRIPT-v8.5x/Version &>/dev/null' >>.bashrc
  echo 'echo "" ' >>.bashrc
